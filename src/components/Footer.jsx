...
function Footer() {
  return (
    <footer className="nodejs-footer">
      <div className="footer-container">
        ...
        <div className="footer-right">
          <span className="copyright">© OpenJS Foundation</span>
          ...
          <div className="social-links">
            ...
            <a href="https://discord.com" aria-label="Discord" className="social-link">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="https://mastodon.social" aria-label="Mastodon" className="social-link">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="https://slack.com" aria-label="Slack" className="social-link">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
