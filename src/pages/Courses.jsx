...
function Courses() {
  ...
  const courses = [
    // IT Helpdesk Technician
    {
      ...
      description: 'Learn essential IT concepts and skills that form the foundation of cybersecurity practices.',
      duration: '20 hours',
      level: 'Beginner',
    ...
    },
    {
      ...
      description: 'Master the basics of computer networking, protocols, and troubleshooting techniques.',
      duration: '25 hours',
      level: 'Beginner',
    ...
    },
    {
      ...
      description: 'Learn to manage and troubleshoot Windows operating systems in enterprise environments.',
      duration: '30 hours',
      level: 'Intermediate',
    ...
    },
    {
      ...
      description: 'Gain practical skills in Linux administration, command line, and basic security configurations.',
      duration: '22 hours',
      level: 'Beginner',
    ...
    },
    {
      ...
      description: 'Develop customer service skills and technical troubleshooting methods for IT support roles.',
      duration: '18 hours',
      level: 'Beginner',
    ...
    // Junior Security Analyst
    {
      ...
      description: 'Introduction to core cybersecurity concepts, terminology, and basic defensive techniques.',
      duration: '24 hours',
      level: 'Beginner',
    ...
    },
    {
      ...
      description: 'Learn to identify, analyze and understand cyber threats and threat actors.',
      duration: '20 hours',
      level: 'Intermediate',
    ...
    },
    {
      ...
      description: 'Develop skills to monitor networks and systems for security events and analyze potential incidents.',
      duration: '28 hours',
      level: 'Intermediate',
    ...
    },
    {
      ...
      description: 'Learn the basics of responding to security incidents and following response procedures.',
      duration: '22 hours',
      level: 'Intermediate',
    ...
    },
    {
      ...
      description: 'Hands-on experience with common security tools used by junior analysts.',
      duration: '26 hours',
      level: 'Intermediate',
    ...
    // Penetration Tester
    {
      ...
      description: 'Learn how to hack like a pro with up-to-date practical hacking techniques.',
      duration: '40 hours',
      level: 'Advanced',
    ...
    },
    {
      ...
      description: 'Master techniques to identify and exploit vulnerabilities in web applications.',
      duration: '35 hours',
      level: 'Advanced',
    ...
    },
    {
      ...
      description: 'Learn methodologies to test network infrastructure security and identify weaknesses.',
      duration: '32 hours',
      level: 'Advanced',
    ...
    },
    {
      ...
      description: 'Discover techniques to test and exploit vulnerabilities in iOS and Android applications.',
      duration: '28 hours',
      level: 'Advanced',
    ...
    },
    {
      ...
      description: 'Learn to develop custom exploits and understand vulnerability exploitation.',
      duration: '45 hours',
      level: 'Expert',
    ...
    // SOC Analyst (Blue Team)
    {
      ...
      description: 'Learn the day-to-day operations of a Security Operations Center and standard procedures.',
      duration: '25 hours',
      level: 'Intermediate',
    ...
    },
    {
      ...
      description: 'Master Security Information and Event Management systems for effective threat detection.',
      duration: '30 hours',
      level: 'Intermediate',
    ...
    },
    {
      ...
      description: 'Develop skills to proactively search for threats that evade existing security solutions.',
      duration: '28 hours',
      level: 'Advanced',
    ...
    },
    {
      ...
      description: 'Learn techniques to analyze various log sources to detect and investigate security incidents.',
      duration: '24 hours',
      level: 'Intermediate',
    ...
    },
    {
      ...
      description: 'Understand malware behavior and develop skills to analyze and detect malicious software.',
      duration: '32 hours',
      level: 'Advanced',
    ...
    // Cybersecurity Manager
    {
      ...
      description: 'Develop leadership skills specific to managing cybersecurity teams and programs.',
      duration: '30 hours',
      level: 'Advanced',
    ...
    },
    {
      ...
      description: 'Learn to implement security governance frameworks and ensure regulatory compliance.',
      duration: '25 hours',
      level: 'Advanced',
    ...
    },
    {
      ...
      description: 'Master methodologies to identify, assess, and mitigate security risks in organizations.',
      duration: '28 hours',
      level: 'Advanced',
    ...
    },
    {
      ...
      description: 'Learn to create effective security strategies aligned with business objectives.',
      duration: '24 hours',
      level: 'Advanced',
    ...
    },
    {
      ...
      description: 'Understand how to budget for security initiatives and demonstrate return on investment.',
      duration: '20 hours',
      level: 'Advanced',
    ...
    // Cyber Defense Analyst
    {
      ...
      description: 'Learn layered security approaches to protect organizational assets from various threats.',
      duration: '26 hours',
      level: 'Intermediate',
    ...
    },
    {
      ...
      description: 'Develop skills to implement effective vulnerability management across the enterprise.',
      duration: '24 hours',
      level: 'Intermediate',
    ...
    },
    {
      ...
      description: 'Learn principles of designing secure systems and network architectures.',
      duration: '30 hours',
      level: 'Advanced',
    ...
    },
    {
      ...
      description: 'Master techniques to identify potential threats and develop appropriate countermeasures.',
      duration: '22 hours',
      level: 'Intermediate',
    ...
    },
    {
      ...
      description: 'Learn to automate security processes to improve efficiency and response capabilities.',
      duration: '28 hours',
      level: 'Advanced',
    ...
    // Network Security
    {
      ...
      description: 'Learn fundamental techniques to secure network infrastructure against various attacks.',
      duration: '30 hours',
      level: 'Intermediate',
    ...
    },
    {
      ...
      description: 'Master the configuration and management of next-generation firewalls.',
      duration: '25 hours',
      level: 'Intermediate',
    ...
    },
    {
      ...
      description: 'Learn to implement and manage IDS/IPS solutions to detect and block network attacks.',
      duration: '28 hours',
      level: 'Intermediate',
    ...
    },
    {
      ...
      description: 'Understand secure implementation of VPNs and remote access solutions.',
      duration: '22 hours',
      level: 'Intermediate',
    ...
    },
    {
      ...
      description: 'Develop skills to monitor network traffic for security events and anomalies.',
      duration: '26 hours',
      level: 'Intermediate',
    ...
    // Security Engineer
    {
      ...
      description: 'Learn to write secure code and implement security throughout the development lifecycle.',
      duration: '32 hours',
      level: 'Advanced',
    ...
    },
    {
      ...
      description: 'Master security techniques for major cloud platforms (AWS, Azure, GCP).',
      duration: '35 hours',
      level: 'Advanced',
    ...
    },
    {
      ...
      description: 'Learn to integrate security into DevOps pipelines and continuous integration processes.',
      duration: '30 hours',
      level: 'Advanced',
    ...
    },
    {
      ...
      description: 'Develop skills to design and implement robust IAM solutions for enterprise environments.',
      duration: '28 hours',
      level: 'Advanced',
    ...
    },
    {
      ...
      description: 'Learn to build automated security solutions using programming and scripting.',
      duration: '34 hours',
      level: 'Advanced',
  ...
  const CourseIcon = ({ category, title, level }) => {
    ...
    const getPatternParams = () => {
      ...
      return patterns[category] || { type: 'default', elements: 4, rotation: seed % 30 };
    };
      ...
      <div className="course-icon-container">
        <div className="ai-pattern-container">
          ...
          >
            {params.type === 'grid' && (
              <>
                <rect x="20" y="20" width="60" height="60" fill="none" stroke="rgba(255,255,255,0.3)" strokeWidth="0.5" />
                <line x1="20" y1="40" x2="80" y2="40" stroke="rgba(255,255,255,0.3)" strokeWidth="0.5" />
                <line x1="20" y1="60" x2="80" y2="60" stroke="rgba(255,255,255,0.3)" strokeWidth="0.5" />
                <line x1="40" y1="20" x2="40" y2="80" stroke="rgba(255,255,255,0.3)" strokeWidth="0.5" />
                <line x1="60" y1="20" x2="60" y2="80" stroke="rgba(255,255,255,0.3)" strokeWidth="0.5" />
            ...
            {params.type === 'hexagon' && (
              <>
                ...
                {Array.from({ length: params.elements }).map((_, i) => {
                  const points = [
                    [50, 30], [70, 40], [70, 60], [50, 70], [30, 60], [30, 40]
                  ];
                  ...
                  return (
                    <g key={i}>
                      ...
                      {Array.from({ length: 2 }).map((_, j) => {
                        ...
                        const nextAngle = (nextI * 360 / params.elements) * (Math.PI / 180);
            ...
            {params.type === 'default' && (
              <>
                <circle cx="50" cy="50" r="25" fill="none" stroke="rgba(255,255,255,0.2)" strokeWidth="0.5" />
                {Array.from({ length: params.elements }).map((_, i) => {
                  const angle = (i * 360 / params.elements) * (Math.PI / 180);
    ...
    <div className="courses-page">
      ...
      <div className="courses-hero">
        <div className="courses-hero-content">
          ...
          <p>Advance your career with our expert-led courses designed for every stage of your cybersecurity journey</p>
        </div>
      </div>
      ...
      <div className="courses-container">
        ...
        <div className="courses-main">
          <div className="courses-header">
            <h2>{careerPaths.find(path => path.id === activeTab)?.name || 'All Courses'}</h2>
              ...
              filteredCourses.map(course => (
                <Link to={`/course/${course.id}`} key={course.id} className="course-card">
                  <div className="course-image">
                    ...
                    <CourseIcon category={course.category} title={course.title} level={course.level} />
                  </div>
                  <div className="course-content">
                    ...
                    <div className="course-meta">
                      ...
                      <span><i className="far fa-user"></i> {course.instructor}</span>
                    </div>
                  </div>
                </Link>
              ))
