...
function SignUp() {
  ...
  return (
    <div className="auth-container">
      ...
      <h1 className="auth-title">Sign in or sign up<br />to access iCyberpathX</h1>
      ...
      <div className="benefits-section">
        ...
        <ul className="benefits-list">
          <li>
            ...
            <span className="benefit-text">Access exclusive cybersecurity resources</span>
          </li>
          <li>
            <span className="benefit-icon">🚀</span>
          ...
          <li>
            <span className="benefit-icon">💬</span>
            <span className="benefit-text">Join our community of security professionals</span>
          </li>
          <li>
            <span className="benefit-icon">📱</span>
      ...
      <div className="terms-footer">
        ...
        and agree to our <Link to="/terms">Terms of Service</Link> and <Link to="/privacy">Privacy Policy</Link>.
      </div>
    </div>
  );
}
